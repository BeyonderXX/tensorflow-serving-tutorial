...
class ModelServiceServicer(object):
  ...
  def GetModelStatus(self, request, context):
    """Gets status of javaLibModel. If the ModelSpec in the request does not specify
    version, information about all versions of the javaLibModel will be returned. If
  ...
  def HandleReloadConfigRequest(self, request, context):
    ...
    so if a javaLibModel is omitted from the new config it will be unloaded and no
    longer served.
    """
    context.set_code(grpc.StatusCode.UNIMPLEMENTED)
    context.set_details('Method not implemented!')
