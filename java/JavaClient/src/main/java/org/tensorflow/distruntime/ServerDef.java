    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 58: {
            org.tensorflow.distruntime.ClusterDeviceFilters.Builder subBuilder = null;
            if (clusterDeviceFilters_ != null) {
              subBuilder = clusterDeviceFilters_.toBuilder();
            }
            clusterDeviceFilters_ = input.readMessage(org.tensorflow.distruntime.ClusterDeviceFilters.parser(), extensionRegistry);
            if (subBuilder != null) {
      ...
      if (clusterDeviceFiltersBuilder_ == null) {
        if (clusterDeviceFilters_ != null) {
          clusterDeviceFilters_ =
            org.tensorflow.distruntime.ClusterDeviceFilters.newBuilder(clusterDeviceFilters_).mergeFrom(value).buildPartial();
        } else {
          clusterDeviceFilters_ = value;
        }
        onChanged();
