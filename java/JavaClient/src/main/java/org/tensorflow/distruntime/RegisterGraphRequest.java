...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 66: {
            ...
            if (configProto_ != null) {
              subBuilder = configProto_.toBuilder();
            }
            configProto_ = input.readMessage(org.tensorflow.framework.ConfigProto.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom(configProto_);
              configProto_ = subBuilder.buildPartial();
            }
  ...
  public static final class Builder extends
    ...
    public org.tensorflow.distruntime.RegisterGraphRequest buildPartial() {
      ...
      if (configProtoBuilder_ == null) {
        result.configProto_ = configProto_;
      } else {
        result.configProto_ = configProtoBuilder_.build();
      }
      onBuilt();
      return result;
    }
  ...
  checkByteStringIsUtf8(value);
     ...
     */
    public boolean hasConfigProto() {
      return configProtoBuilder_ != null || configProto_ != null;
    }
    /**
     * <pre>
     * ConfigProto from the session in which this graph was created.
    ...
    public Builder mergeConfigProto(org.tensorflow.framework.ConfigProto value) {
      if (configProtoBuilder_ == null) {
        if (configProto_ != null) {
          configProto_ =
            org.tensorflow.framework.ConfigProto.newBuilder(configProto_).mergeFrom(value).buildPartial();
        } else {
          configProto_ = value;
        }
        onChanged();
