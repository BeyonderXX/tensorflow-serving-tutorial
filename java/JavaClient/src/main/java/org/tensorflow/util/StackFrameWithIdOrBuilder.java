...
public interface StackFrameWithIdOrBuilder extends
   ...
   */
  org.tensorflow.framework.GraphDebugInfo.FileLineCol getFileLineCol();
  /**
   * <pre>
   * Stack frame, i.e., a frame of a stack trace, containing information
   * regarding the file name, line number, function name, code content
   ...
   * <code>.tensorflow.GraphDebugInfo.FileLineCol file_line_col = 2;</code>
   */
  org.tensorflow.framework.GraphDebugInfo.FileLineColOrBuilder getFileLineColOrBuilder();
}
